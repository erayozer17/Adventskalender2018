...
import com.ozer.eray.adventskalender2018.ui.camera.CameraSourcePreview;
import com.ozer.eray.adventskalender2018.ui.camera.GraphicOverlay;
...
public final class FaceTrackerActivity extends AppCompatActivity {
    ...
    private class GraphicFaceTracker extends Tracker<Face> {
        ...
        public boolean kuralDondur(int gun, Face face){
            int kural = gun % 8;
            boolean gul = face.getIsSmilingProbability() > 0.3f;
            boolean gulme = face.getIsSmilingProbability() < 0.5f;
            boolean sagGozunuKapat = face.getIsRightEyeOpenProbability() < 0.5f;
            boolean sagGozunuAc = face.getIsRightEyeOpenProbability() > 0.5f;
            boolean solGozunuKapat = face.getIsLeftEyeOpenProbability() < 0.5f;
